...
function createChain(fn, defaults) {
	...
	extendChain(root.only, 'cb', 'exclusive');
	extendChain(root.skip, 'cb', 'skipped');
	...
	extendChain(root.serial.only, 'cb', 'exclusive');
	extendChain(root.serial.skip, 'cb', 'skipped');
	...
	extendChain(root.serial.failing.only, 'cb', 'exclusive');
	extendChain(root.serial.failing.skip, 'cb', 'skipped');
